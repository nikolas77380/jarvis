...
(bin/backends/herdr.sh dj_backend_herdr_wait_transition). It deliberately does
NOT know jarvis's supervision policy: it opens ONE connection to a herdr
...
shape and applies the single-owner policy table (bin/dj-transition-lib.sh); the
