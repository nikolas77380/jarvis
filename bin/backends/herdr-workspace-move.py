...
This helper is the wire transport for Jarvis's optional presentation-only
...
Wire protocol verified against Herdr 0.7.4, protocol 16:
  ...
  request:  {"id":"dj-workspace-move","method":"workspace.move",
             "params":{"workspace_id":W,"insert_index":N}}\n
  response: {"id":"dj-workspace-move","result":
