...
#
# The dj-secondmate-parent.v1 record contains exactly one schema and route.
...
# Writers publish this record before .dj-secondmate-home so that the identity
# marker remains the seed-completion point.

dj_secondmate_parent_record_parse() {
  ...
  DJ_SECONDMATE_PARENT_ROUTE=
  DJ_SECONDMATE_PARENT_HOME=
  DJ_SECONDMATE_PARENT_HOST=
  ...
  DJ_SECONDMATE_PARENT_ROUTE=$route
  DJ_SECONDMATE_PARENT_HOST=$parent_host
}
