#!/usr/bin/env bash
# dj-secondmate-report.sh - optional helper to append a correlated parent report.
#
# A secondmate answering a marked from-jarvis request must report on the
...
#
# Usage:
#   dj-secondmate-report.sh <status-file> <verb> <corr_id> <note...>
#   dj-secondmate-report.sh --doc <status-file> <verb> <corr_id> <doc-path> <note...>
#
# Examples:
#   dj-secondmate-report.sh "$STATUS" done abcdef0123456789 "audit clean"
#   dj-secondmate-report.sh --doc "$STATUS" done abcdef0123456789 data/x/report.md "see report"
#
