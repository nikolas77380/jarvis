...
This record supports the active guarantee that Jarvis can discover and JIT-load a user-owned local skill excluded through the clone's `.git/info/exclude`.
