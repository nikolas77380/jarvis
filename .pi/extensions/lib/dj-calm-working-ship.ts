// Jarvis's Calm-only animated working presentation.
//
...
// temporary TUI widget; `.pi/extensions/dj-calm.ts` owns when the presentation is
...
export const CALM_WORKING_SHIP_WIDGET_KEY = "jarvis-calm-working-ship";
