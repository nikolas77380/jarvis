...
description: Turn decisions or facts held by one unavailable stakeholder into a questionnaire for that person. Use when progress depends on several related answers outside the user, agent, and codebase; do not use when research or repository inspection can supply the answers.
---
