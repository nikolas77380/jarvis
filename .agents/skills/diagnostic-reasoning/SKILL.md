...
This skill is the single owner of Jarvis's bug-diagnosis reasoning procedure.
Jarvis applies it when briefing delegated investigation and evaluating the resulting evidence, without taking over project-specific investigation itself.
